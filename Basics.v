...
Proof.
  ...
  - simpl. intros H. rewrite H. reflexivity. (* 둘이 같음 *)
  - reflexivity.
Qed.
...
Definition grade_comparison (g1 g2 : grade) : comparison :=
  ...
  | Grade l1 m1, Grade l2 m2 => (
    let lc := letter_comparison l1 l2 in
    match lc with
...
Proof.
  ...
  - destruct m.
    ...
    + simpl lower_grade. 
      ...
      rewrite letter_comparison_Eq. 
      reflexivity.
    + destruct l; simpl lower_grade; simpl grade_comparison.
      -- reflexivity.
      -- reflexivity.
      -- reflexivity.
      -- reflexivity.
      -- simpl grade_comparison in H.
         discriminate.
Qed.
...
Proof.
  ...
  unfold apply_late_policy. (* 이게 더 나음 *)
  rewrite H.
  reflexivity.
Qed.
